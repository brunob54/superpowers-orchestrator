 ...
 *
 * @param {string} skillName - Name like "superpowers:brainstorming", "superpowers-orchestrator:brainstorming", or "my-skill"
...
function resolveSkillPath(skillName, superpowersDir, personalDir) {
    ...
    const forceSuperpowers = skillName.startsWith('superpowers:') || skillName.startsWith('superpowers-optimized:') || skillName.startsWith('superpowers-orchestrator:');
    const actualSkillName = forceSuperpowers
        ? skillName.replace(/^(superpowers|superpowers-optimized|superpowers-orchestrator):/, '')
        : skillName;
